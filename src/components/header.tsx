...
export default function Header() {
    ...
    return (
        <div className="fixed w-full h-20 sm:h-25 flex z-10">
            <div className="fixed w-full h-12 sm:h-25 flex outline-2 outline-white bg-[rgb(221,11,20)] mt-5 z-10">
                <img className="fixed left-11 top-3 scale-70 sm:left-38 sm:top-8 z-11 sm:scale-85" src={logo} />
                <p className="fixed hidden sm:block text-black fontFamLogo left-35 top-33 z-11">ALEXEY PETROV</p>
                <img className="fixed h-[91px] w-[243px] scale-55 sm:scale-90 top-10 sm:top-28 -left-8 sm:left-20 z-9" src={header} alt=""></img>
            ...
            <img className="fixed h-[91px] w-[243px] scale-56 sm:scale-92 top-10.5 sm:top-28.5 -left-8 sm:left-20 z-5" src={headerWhite} alt=""></img>
        </div>
    )
}

...
function App() {
  ...
  return (
    <div className='w-screen flex flex-col relative'>
      <button hidden className='w-15 h-8 text-black fixed bg-gray-300 rounded z-3 top-13 left-10 shadow-2xl -translate-x-1/2 cursor-pointer' onClick={() => setClicked(!clicked)}>HIDE</button>

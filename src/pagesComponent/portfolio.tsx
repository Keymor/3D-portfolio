...
export default function Portfolio() {
    ...
    return (
        <div className="w-screen h-screen bg-white flex flex-col inset-shadow-[0_20px_30px_rgb(0,0,0,0.3)] relative pt-15 pb-2">
            ...
            <div className="sm:hidden flex flex-row m-auto bg-red-400 w-[90vw] gap-2">
                <div className="h-[60vh] w-[60vw] bg-gray-500"></div>
                <div className="h-[75vh] w-[8vw] relativ">
                    <h1 className="portfolioSmall whitespace-nowrap -translate-x-3/10 text-start text-9xl">PORTFOLIO</h1>
                </div>
            </div>

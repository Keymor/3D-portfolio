...
export default function Contact() {
    ...
    return (
        <div className="w-screen h-[100lvh] bg-[rgb(221,11,20)] flex flex-col relative">
            <div className=" absolute top-0 left-0 w-full h-16 sm:h-30 bg-white" />
            <img className="absolute h-[91px] w-[243px] scale-55 sm:scale-92 top-10 sm:top-28 -left-8 sm:left-20 z-9" src={headerWhite} alt=""></img>
